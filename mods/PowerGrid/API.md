...
Current PowerGrid `0.3.0` builds expose API version `1`.
...
Future versions can expand the contract, but `0.3.0` intentionally keeps the surface small and reliable.
