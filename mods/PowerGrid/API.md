...
Current PowerGrid `0.3.1` builds expose API version `1`.
...
Future versions can expand the contract, but `0.3.1` intentionally keeps the surface small and reliable.
