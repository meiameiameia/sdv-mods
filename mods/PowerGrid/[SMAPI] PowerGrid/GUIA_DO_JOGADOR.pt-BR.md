...
Clique com o botão direito em um Gerador a Vapor segurando Carvão, Madeira ou Madeira de Lei para abastecer. Clique com o botão direito em um Gerador de Combustão segurando Biocombustível para abastecer.
...
| --- | --- | ---: |
| Bateria de Energia Básica | Bateria x1, Barra de Cobre x5, Quartzo Refinado x2 | 500 EU |
| Bateria de Energia de Irídio | Bateria x3, Barra de Irídio x2, Quartzo Refinado x5 | 2.000 EU |
...
| --- | --- | ---: | ---: |
| Jarra de Conserva Industrial | Madeira x30, Carvão x6, Barra de Ferro x6, Quartzo Refinado x1 | 20 EU/tick | 20% mais rápida |
| Barril de Metal | Barra de Ferro x8, Barra de Cobre x6, Quartzo Refinado x1 | 10 EU/tick | 20% mais rápido |
| Barril de Irídio Rígido | Barra de Irídio x5, Barra de Ferro x4, Quartzo Refinado x1 | 30 EU/tick | 30% mais rápido |
| Barril de Envelhecimento de Metal | Madeira de Lei x10, Barra de Ferro x8, Barra de Irídio x3, Quartzo Refinado x1 | 40 EU/tick | 50% mais rápido para envelhecer |
