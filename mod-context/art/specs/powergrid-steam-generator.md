...
- Body-mass / sturdiness rule: the lower two-thirds should read as compact, sturdy machinery with enough body mass to feel planted beside vanilla big craftables
...
- Top plane is clearly readable at `1x`, and the machine body feels grounded instead of thin or front-on.
